# Generated by Django 3.0.5 on 2021-08-10 09:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveIntegerField(validators=[django.core.validators.MaxValueValidator(200)], verbose_name='Age')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialization', models.CharField(max_length=200, verbose_name='Specialization of Doctor')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Patient', verbose_name='patientsTreating')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
